...
<div class="w3-top ">
    ...
    <?php 
        if(isset($_REQUEST['txtquiz'])) {
            ...
            $txtchoiceA = $_POST["txtchoiceA"];
            $txtchoiceB = $_POST["txtchoiceB"];
            $txtchoiceC = $_POST["txtchoiceC"];
            $txtchoiceD = $_POST["txtchoiceD"];
            $txtcorrect = $_POST["txtcorrect"];
            if ($txtquiz != "" && $txtchoiceA != "" && $txtchoiceB != "" && $txtchoiceC != "" && $txtchoiceD != "" && $txtcorrect != "" ) {
                $query = "INSERT INTO quiz (quizID, quiz, choiceA, choiceB, choiceC, choiceD, correct) VALUES ('$newid', '$txtquiz', '$txtchoiceA', '$txtchoiceB', '$txtchoiceC','$txtchoiceD', '$txtcorrect')";
    ...
    <form action="" method="post" name="frmMain" id="frmMain">
        <table width="100%" cellpadding="1" cellspacing="1">
            <tr>
                <td><p style="font-size:25px;"> Quiz </p></td>
            </tr>
            <tr>
                <td><input name="txtquiz" type="text" id="txtquestion" value="" class="form-control w3-xlarge"></td>
            </tr>
            <tr>
                <td><p style="font-size:25px;"> ChoiceA </p></td>
            </tr>
            <tr>
                <td><input name="txtchoiceA" type="text" id="txtchoiceA" value="" class="form-control w3-xlarge"></td>
            </tr>
            <tr>
                <td><p style="font-size:25px;"> ChoiceB </p></td>
            </tr>
            <tr>
                <td><input name="txtchoiceB" type="text" id="txtchoiceB" value="" class="form-control w3-xlarge"></td>
            </tr>
            <tr>
                <td><p style="font-size:25px;"> ChoiceC </p></td>
            </tr>
            <tr>
                <td><input name="txtchoiceC" type="text" id="txtchoiceC" value="" class="form-control w3-xlarge"></td>
            </tr>
            <tr>
                <td><p style="font-size:25px;"> ChoiceD </p></td>
            </tr>
            <tr>
                <td><input name="txtchoiceD" type="text" id="txtchoiceD" value="" class="form-control w3-xlarge"></td>
            </tr>
            <tr>
                <td><p style="font-size:25px;"> Correct </p></td>
            </tr>
            <tr>
                <td><input name="txtcorrect" type="text" id="txtcorrect" value="" class="form-control w3-xlarge"></td>
            </tr>
        </table> <br>
