...
CREATE TABLE `quiz` (
  ...
  `quiz` varchar(500) COLLATE utf8_general_ci NOT NULL,
  `choiceA` varchar(500) COLLATE utf8_general_ci NOT NULL,
  `choiceB` varchar(500) COLLATE utf8_general_ci NOT NULL,
  `choiceC` varchar(500) COLLATE utf8_general_ci NOT NULL,
  `choiceD` varchar(500) COLLATE utf8_general_ci NOT NULL,
  `correct` varchar(500) COLLATE utf8_general_ci NOT NULL
